...
try:
    ...
    from pyatv.exceptions import (AuthenticationError, BlockedStateError,
                                  ...
                                  ConnectionLostError, InvalidCredentialsError,
                                  InvalidStateError, NoCredentialsError,
                                  NotSupportedError, PairingError)
...
class AppleTvManager:
    ...
    def run(self, coro, timeout=12):
        ...
        except (ConnectionLostError, ConnectionFailedError) as e:
